...
exports.offer = async (req, res, db) => {
    ...
    if (is_offer_available) {
        ...
        if (typeof(early_repayment) !== "boolean") {
            aboutTypes.push("early_repayment - has to be a number");
        }
    ...
    try {
        ...
        if (!checkIfApplicationExists) {
            ...
            sendOfferToBubble(res, newOffer);
...
async function sendOfferToBubble(res, newOffer) {
    setTimeout(async function() {
        fetch("https://kompar.bubbleapps.io/version-test/api/1.1/wf/kompar_api_offer_from_lender", {
                method: "POST",
                body: JSON.stringify({
