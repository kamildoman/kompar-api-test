                        ...
                        await db.collection(config.DB.names.client).updateOne(
                            {
                                ...
                                "applications.offers.lender_id": lender_id
                            },
                            {
                                "$set": {
                                    "applications.$.offers.$[replyoffer].status": "Closed",
                            ...
                            { "arrayFilters":
                                [
                                    { "replyoffer.lender_id": lender_id }
                                ]
                            }
                        );
                        ...
                        await db.collection(config.DB.names.client).updateOne(
                            ...
                            {   
                                "$set": {
                                    ...
                                    "applications.$.offers[$replyOffer].signedDateUTC": Date.now()
                                }
                            },
                            { 
