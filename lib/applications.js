        ...
        if (checkIfApplicationExists == null) {
            ...
            if (decisionWebhook) {
                ...
                if (is_offer_available) {
                    ...
                    offer["lender_id"] = parseInt(res.locals.partner_id);
                    ...
                    offer["partner_interest"] = (interest).toFixed(2);
                    offer["interest"] = ((((parseFloat(total) / parseFloat(amount.replace(/ /g, ""))) - 1) / parseFloat(duration)) * 100).toString();
                    offer["rating"] = rating;
                    // TODO new phone
                    offer["lender_phone"] = "";
                    offer["fees"] = {
