    ...
    if (id != null) {
        try {
            ...
            if (!application) {
                ...
                return res.status(400).send({ "success": false, "message": "Application with this id doesn't exist." });
            } else {
                const sent = [];
                ...
                return Promise.all(promises)
                    .then(async () => {
                        ...
                        logger.info(`WEBHOOKS - SEND TO LENDERS - Application ${id} has been sent to lenders via webhook. Sent to: ${sent}.`);
